...
echo "🔍 NetView Monitoring Troubleshooting"
echo "======================================"
echo ""
...
echo ""
echo "6. Quick fixes:"
echo "   • Restart monitoring: docker-compose down && docker-compose up -d"
echo "   • Re-setup Grafana: ./setup-grafana.sh"
echo "   • Re-import dashboard: ./import-dashboard.sh"
